      ...
      {selectedGroup && (
        <div className={styles.modeContainer}>
          {selectedMode === "classic" && (
            <ClassicMode people={people} date={date} group={selectedGroup} />
          )}
          {selectedMode === "swipe" && (
            <SwipeMode people={people} date={date} group={selectedGroup} />
          )}
          {selectedMode === "quick" && (
            <QuickMode people={people} date={date} group={selectedGroup} />
          )}
          {selectedMode === "group" && (
